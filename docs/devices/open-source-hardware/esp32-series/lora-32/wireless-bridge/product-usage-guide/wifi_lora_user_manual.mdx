---
sidebar_position: 2
title: WiFi_LoRa Example User Manual
---
...
- **Heltec ESP32 development framework and library**, If you don't know how to install, you can refer to this link:[Heltec ESP32 Series Quickstart](/docs/devices/open-source-devices/esp32-series/esp32-quick-start?esp32=esp32)
...
``` {tip} The default frequency band is 0~ 7. If you don't know how to set the frequency band, you can check this link:[LoRaWAN example Sub-Band usage](/docs/devices/general-docs/lorawan-instructions/lorawan-sub-band-usage)
```
...
- [HT-M02](/docs/devices/lora-gateway/ht-m02-v2-edge-lora-gateway/)
- [HT-M7603](/docs/devices/lora-gateway/ht-m7603-indoor-lora-gateway/)
- [HT-M01S](docs/devices/lora-gateway/ht-m01s-v2-indoor-lora-gateway/)

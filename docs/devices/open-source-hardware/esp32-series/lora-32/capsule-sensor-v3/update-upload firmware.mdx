...
:::warning
The progress bar at the top left, please upload one firmware before uploading another.
:::

:::warning
The size of the capacity of each partition, do not allow the uploaded firmware size to exceed the capacity of the partition.
:::

:::warning
The name of the firmware should not be too long, otherwise it will not be uploaded.
:::

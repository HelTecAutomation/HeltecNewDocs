...
---
# Wireless Paper Frequently Asked Questions
...
If not, check the link to try activating: [How to Use License — main latest documentation (heltec.org)](docs/devices/general-docs/how_to_use_license)

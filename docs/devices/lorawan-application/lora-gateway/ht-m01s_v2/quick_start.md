...
:::tip
For HT-M01S (Rev. 2.0), AS923_ 1 corresponding frequency points are 923.2MHz ~924.6MHz, AS923_ 2 corresponding frequency points are 921.4MHz ~922.8MHz, AS923_ 3 corresponding frequency points are 916.6MHz ~918.0MHz, AS923_ 4 corresponding frequency points are 917.3MHz  ~918.7MHz.
:::
...
:::tip
After the gateway is connected to the network through WiFi or Ethernet and works normally, you can directly enter the configuration interface through the "Local IP" on the display (the login device must be in the same LAN as the gateway).
:::

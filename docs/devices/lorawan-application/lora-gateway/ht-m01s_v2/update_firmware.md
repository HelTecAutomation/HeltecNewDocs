...
Enter the HT-M01S (Rev. 2.0) gateway configuration interface (can refer to [HT-M01S (Rev. 2.0) Quick Start](/docs/devices/lora-gateway/ht-m01s_v2/quick_start))，click "Firmwaer Update"。

---
sidebar_position: 1
title: HRI 4853 TCP/UDP/MQTT Converter 
---
...
{<div className={styles.btnContainer}>
  <a href="https://heltec.org/project/rs4853-tcp-udp-mqtt-converter/" className={styles.btnLink1}>
    Product Page
  </a>
</div>}
...
| [parameters](https://resource.heltec.cn/download/HRI-485X/HRI-485x.pdf)         | HRI-4853        |
|--------------------|----------------------------|
|MCU     |	    	ESP32DOWDQ6         |
|LTE module |    	Air724UG              |
